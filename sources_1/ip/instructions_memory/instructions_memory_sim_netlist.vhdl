...
architecture STRUCTURE of instructions_memory_rom is
  ...
  attribute SOFT_HLUTNM of \spo[39]_INST_0\ : label is "soft_lutpair3";
...
\spo[39]_INST_0_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0001"
    )
        port map (
...
architecture STRUCTURE of instructions_memory_dist_mem_gen_v8_0_13 is
  ...
  signal \^spo\ : STD_LOGIC_VECTOR ( 51 downto 0 );
begin
  dpo(63) <= \<const0>\;
  dpo(62) <= \<const0>\;
  dpo(61) <= \<const0>\;
